...
namespace ConsoleApp
{
    public class ChooseCommentDialog : Dialog
    {
        ...
        public ChooseCommentDialog()
        {
            ...
            Button unPinButton = new Button(4, 18, "Unpin comment");
            this.Add(unPinButton);
            unPinButton.Clicked += OnUnpinCommentClicked;
        ...
        private void OnUnpinCommentClicked()
        {
            selectedComment = null;
            MessageBox.Query("Unpin comment", "Comment unpinned", "Ok");
